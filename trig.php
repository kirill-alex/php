<?php
// ──────────────────────────────────────────────────────────────────
// trig.php — библиотека тригонометрических функций
//
// Использует символическую ссылку (variable function / call_user_func),
// чтобы по строковому имени функции вызвать нужную реализацию.
//
// Поддерживаемые функции: sin, cos, tan, asin, acos, atan
// Аргумент принимается в ГРАДУСАХ, переводится в радианы внутри.
// ──────────────────────────────────────────────────────────────────
